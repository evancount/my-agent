...
| 任務                           | 對應資料夾                             |
| :----------------------------- | :------------------------------------- |
| 寫草稿（貼文、影音腳本）       | `100_Todo/drafts/`（看子資料夾分類）   |
...
> 當我要你「寫一篇貼文」「寫一段腳本」時：**先翻 `200_Reference/writing-samples/` 找 2-3 個我過去的範例學語氣**，再開始寫。不要憑空想像我的風格。
